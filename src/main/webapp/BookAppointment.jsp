		...
		<form action="BookAppointmentServlet">
			<div class="row">
				...
				<div class="col-md-6">
					...
					int bappointment = appointmentService.getBookedcount(doctorId, date);
					if(bappointment != 0 ){
						availableAppointment = availableAppointment - bappointment;
					}
					%>
					<br /> <br /> <Label for="OPFrom"> From: </Label> <input
						type="time" id="fromtime" name="opFrom"
						value="<%=doctor.getOpFrom()%>" readonly><br /> <br /> <Label
